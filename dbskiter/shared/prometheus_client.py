...
class PrometheusClient:
    ...
    def query_range(self, promql: str, start: datetime, end: datetime, step: str = "5m") -> Dict[str, Any]:
        """
        范围查询 - 获取历史趋势
...
class RDSMetrics:
    ...
    def get_group_metrics(self, group_name: str) -> Dict[str, Any]:
        ...
        result = {"group": group_name, "timestamp": datetime.now().isoformat(), "nodes": {}}
    ...
    def get_metric_history(self, instance_name: str, metric: str, hours: int = 1) -> List[Dict[str, Any]]:
        """
        获取指标历史趋势
        ...
        for item in response["data"].get("result", []):
            for timestamp, value in item["values"]:
                history.append({"timestamp": datetime.fromtimestamp(timestamp).isoformat(), "value": float(value)})
    ...
    def get_core_metrics(self, instance_name: str) -> Dict[str, Any]:
        ...
        result = {"instance": instance_name, "timestamp": datetime.now().isoformat(), "metrics": {}}
