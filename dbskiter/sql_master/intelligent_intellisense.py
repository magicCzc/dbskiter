...
class SQLIntelliSense:
    ...
    def get_suggestions(self, sql: str, cursor_pos: int, context: Optional[Dict] = None) -> List[SemanticSuggestion]:
        """
        获取智能建议
    ...
    def _get_context_suggestions(
        self, parse_result: SQLParseResult, sql: str, cursor_pos: int
    ...
    def _get_best_practice_suggestions(self, parse_result: SQLParseResult) -> List[SemanticSuggestion]:
        """获取最佳实践建议"""
        suggestions = []
    ...
    def format_suggestions(self, suggestions: List[SemanticSuggestion], max_count: int = 10) -> str:
        """
        格式化建议输出
