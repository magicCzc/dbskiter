...
class CacheInvalidator:
    ...
    def get_table_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "table_details": {table: len(keys) for table, keys in self._table_index.items()},
        }
...
class SmartCachedExecutor:
    ...
    def __init__(self, executor, cache_manager, enable_cache: bool = True, enable_auto_invalidate: bool = True):
    ...
    def execute(self, sql: str, params: Optional[Dict] = None, use_cache: bool = True) -> Any:
        """
        执行SQL（带智能缓存）
