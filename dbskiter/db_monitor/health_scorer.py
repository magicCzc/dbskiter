...
class HealthScorer:
        ...
        oracle_config = DatabaseTypeConfig(
            ...
            metrics={
                MetricType.CONNECTIONS_ACTIVE: MetricWeight(
                    ...
                    weight=15.0,
                    threshold=MetricThreshold(warning=60.0, critical=80.0),  # 连接数超过60%警告  # 超过80%严重
                ...
                MetricType.BUFFER_HIT_RATIO: MetricWeight(
                    ...
                    weight=20.0,
                    threshold=MetricThreshold(
                        warning=90.0, critical=85.0, direction="below"  # 低于90%警告  # 低于85%严重
                    ),
                    description="缓冲命中率",
                ),
                MetricType.SLOW_QUERIES: MetricWeight(
                    ...
                    weight=10.0,
                    threshold=MetricThreshold(warning=10.0, critical=50.0),  # 超过10个慢查询警告  # 超过50个严重
                    description="慢查询数量",
                ),
                MetricType.LOCK_WAITS: MetricWeight(
                    metric_type=MetricType.LOCK_WAITS,
                    weight=15.0,
                    threshold=MetricThreshold(warning=5.0, critical=20.0),  # 超过5次/秒警告  # 超过20次/秒严重
                    description="锁等待频率",
                ),
                MetricType.DEADLOCKS: MetricWeight(
                    metric_type=MetricType.DEADLOCKS,
                    weight=25.0,
                    threshold=MetricThreshold(warning=0.1, critical=1.0),  # 超过0.1次/秒警告  # 超过1次/秒严重
                    description="死锁频率",
                ),
                MetricType.QUERY_TIME_AVG: MetricWeight(
                    metric_type=MetricType.QUERY_TIME_AVG,
                    weight=10.0,
                    threshold=MetricThreshold(warning=1.0, critical=5.0),  # 超过1秒警告  # 超过5秒严重
                    description="平均查询时间",
                ),
                MetricType.CPU_USAGE: MetricWeight(
                    metric_type=MetricType.CPU_USAGE,
                    weight=5.0,
                    threshold=MetricThreshold(warning=70.0, critical=90.0),  # 超过70%警告  # 超过90%严重
                    description="CPU使用率",
                ),
            },
        )
        ...
        mysql_config = DatabaseTypeConfig(
            ...
            metrics={
                MetricType.CONNECTIONS_ACTIVE: MetricWeight(
                    metric_type=MetricType.CONNECTIONS_ACTIVE,
                    weight=15.0,
                    threshold=MetricThreshold(warning=60.0, critical=80.0),
                    description="活跃连接数使用率",
                ),
                MetricType.BUFFER_HIT_RATIO: MetricWeight(
                    metric_type=MetricType.BUFFER_HIT_RATIO,
                    weight=20.0,
                    threshold=MetricThreshold(warning=95.0, critical=90.0, direction="below"),  # MySQL要求更高
                    description="缓冲命中率",
                ),
                MetricType.SLOW_QUERIES: MetricWeight(
                    metric_type=MetricType.SLOW_QUERIES,
                    weight=10.0,
                    threshold=MetricThreshold(warning=20.0, critical=100.0),
                    description="慢查询数量",
                ),
                MetricType.LOCK_WAITS: MetricWeight(
                    metric_type=MetricType.LOCK_WAITS,
                    weight=15.0,
                    threshold=MetricThreshold(warning=10.0, critical=50.0),
                    description="锁等待频率",
                ),
                MetricType.DEADLOCKS: MetricWeight(
                    metric_type=MetricType.DEADLOCKS,
                    weight=25.0,
                    threshold=MetricThreshold(warning=0.1, critical=1.0),
                    description="死锁频率",
                ),
                MetricType.QUERY_TIME_AVG: MetricWeight(
                    metric_type=MetricType.QUERY_TIME_AVG,
                    weight=10.0,
                    threshold=MetricThreshold(warning=1.0, critical=5.0),
                    description="平均查询时间",
                ),
                MetricType.CPU_USAGE: MetricWeight(
                    metric_type=MetricType.CPU_USAGE,
                    weight=5.0,
                    threshold=MetricThreshold(warning=70.0, critical=90.0),
                    description="CPU使用率",
                ),
            },
        )
    ...
    def calculate_score(
        self, metrics: Dict[MetricType, float], db_type: str, max_connections: float = 2000.0
        ...
        for metric_type, value in metrics.items():
            ...
            issues.append(f"{metric_config.description}: {value:.2f} ({severity_label})")
    ...
    def get_metric_advice(self, metric_type: MetricType, value: float, db_type: str) -> Optional[str]:
        """
        获取指标优化建议
