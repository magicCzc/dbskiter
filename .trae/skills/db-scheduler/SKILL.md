...
| "验证备份" | `python -m dbskiter --output-mode=ai --database=<name> scheduler backup verify` | 验证备份完整性 |
| "恢复数据库" | `python -m dbskiter --output-mode=ai --database=<name> scheduler backup restore` | 从备份恢复 |
